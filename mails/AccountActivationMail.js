...
export const AccountActivationEmail = async (email, data) => {
  ...
  const transport = nodemailer.createTransport({
    ...
    port: 587,
    auth: {
      user: "ea1725429@gmail.com",
      pass: "ssaz fcoe omqx rjqj",
    },
  });
  await transport.sendMail({
    from: "Blood Donation <ea1725429@gmail.com>",
    subject: "Activate",
    to: email,
    html: `
...
<div align="center" class="alignment" style="line-height:10px"><img alt="I'm an image" src="https://oneblood.scene7.com/is/image/oneblood/About-blood-drop?ts=1701100554337&$BRBangle$&dpr=off" style="display: block; height: auto; border: 0; max-width: 120px; width: 100%;" title="I'm an image" width="120"/></div>
</td>
</tr>
</table>
