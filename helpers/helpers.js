 ...
 * Dot to Hy
 */
export const dotsToStrings = (inputString) => {
  // Use the replace method with a regular expression to replace dots with hyphens
  const stringWithHyphens = inputString.replace(/\./g, "blddnn");
 ...
 * Hypens to Dots
 */
export const stringsToDots = (inputString) => {
  // Use the replace method with a regular expression to replace hyphens with dots
  const stringWithDots = inputString.replace(/blddnn/g, ".");
